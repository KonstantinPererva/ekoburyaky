		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 hidden-sm hidden-xs">
					<div class="sidebar">
						<nav class="menu_sidebar">
							<ul class="menu_s list-unstyled">
								<li>
									<a href="index.php" class="aside-link-1" id="index-0"><i class="fa fa-pagelines" aria-hidden="true"></i>
										О нас
									</a>
								</li>
								<li class="dropdown" style="position:relative">
									<a href="#" data-toggle="dropdown" class="aside-link-1" id="index-1"><i class="fa fa-pagelines" aria-hidden="true"></i>
										Наши технологии
								...
								<li class="dropdown" style="position:relative">
									...
									<ul class="dropdown-menu">
										<li>
											<a class="trigger right-caret" class="aside-link">Продукты питания</a>

											<ul class="dropdown-menu sub-menu">
												<li>
													<a href="products.php?product=milk" class="aside-link">Молочные</a>
												</li>
												<li>
													<a href="products.php?product=vegetables_and_fruits" class="aside-link">Свежие овощи, фрукты</a>
												</li>
												<li>
													<a href="products.php?product=conservation" class="aside-link">Консервация</a>
												</li>
												<li>
													<a href="products.php?product=drying" class="aside-link">Сушка</a>
												</li>
											</ul>
										</li>
										<li>
										...
										<li>
											<a href="products.php?product=service" class="aside-link">Услуги</a>
										</li>
									</ul>
								</li>
								<li>
									<a href="articles.php" class="aside-link-1" id="index-3">
										<i class="fa fa-pagelines" aria-hidden="true"></i>
										Статьи
									</a>
								</li>
								<li>
									<a href="cooperation.php" class="aside-link-1" id="index-4">
										<i class="fa fa-pagelines" aria-hidden="true"></i>
										Сотрудничество
									</a>
								</li>
								<li>
									<a href="contacts.php" class="aside-link-1" id="index-5">
										<i class="fa fa-pagelines" aria-hidden="true"></i>
										Контакты
									</a>
								</li>
				...
				<div class="col-md-9 col-xs-12 p-r">
					<div class="content">